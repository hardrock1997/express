...
const dbURL = "mongodb+srv://<username>:<password>@cluster0.5leqd.mongodb.net/<dbName>?retryWrites=true&w=majority&appName=Cluster0"
...
mongoose.connect(newDbURL).then(()=>{
